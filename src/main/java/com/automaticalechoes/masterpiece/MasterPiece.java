package com.automaticalechoes.masterpiece;
...
@Mod(MasterPiece.MODID)
public class MasterPiece
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "masterpiece";
    ...
    public static final RegistryObject<CreativeModeTab> REDSTONE_HOOKER = CREATIVE_MODE_TABS.register("masterpiece", () -> CreativeModeTab.builder()
    ...
    public MasterPiece()
    {
        ...
        ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, Config.SPEC,"master_piece_common.toml");
    }
