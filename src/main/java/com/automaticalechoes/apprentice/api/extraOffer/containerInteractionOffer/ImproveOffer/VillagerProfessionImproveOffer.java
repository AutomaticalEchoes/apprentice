...
public class VillagerProfessionImproveOffer {
    ...
    public static final ModifierImprove TOOLS = new ModifierImprove(new ItemStack(Items.EMERALD, Config.IMPROVE_COST.get()), Tags.Items.TOOLS,OfferUtils.getRandomModifier(),ModelItem.TOOL,ModelItem.TOOL_IMPROVE);
    public static final ModifierImprove WEAPONS = new ModifierImprove(new ItemStack(Items.EMERALD, Config.IMPROVE_COST.get()), OfferUtils.WEAPONS, OfferUtils.getRandomModifier(), ModelItem.TOOL,ModelItem.TOOL_IMPROVE);
    public static final EnchantmentImprove ENCHANTMENT_IMPROVE = new EnchantmentImprove(new ItemStack(Items.EMERALD,Config.IMPROVE_COST.get()), Tags.Items.ENCHANTING_FUELS,OfferUtils.getRandomNumber(),ModelItem.ENCHANTABLE,ModelItem.ENCHANTED_ITEM);
