...
public class VillagerProfessionImproveOffer {
    ...
    public static final ModifierImprove WEAPONS = new ModifierImprove(new ItemStack(Items.EMERALD, OfferUtils.RandomImproveCost()), Tags.Items.TOOLS, OfferUtils.RandomModifier(), ModelItem.TOOL,ModelItem.TOOL_IMPROVE);
